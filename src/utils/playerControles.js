const stations = [ 'iaD7Nw8k', '6Jsnem7i848', 'Dx5qFachd3A', 'UedTcufyrHc', '4xDzrJKXOOY', 'y6TZHLAzg5o', 'et5HueFNjkI','2gO1v2GPMFk', 'tYR6tvtb0', 'DSGyEsJ17cI', 'fEvM-OUbaKs', '5yx6BWlEVcY', 'rPjez8z61rI', 'SfYqbEY-CS0'];

const getPreviousStationId = (id) => {
    const currentStationIndex = stations.findIndex(stationId => stationId === id);
...
export { getNextStationId, getPreviousStationId, getRandomStantionId }